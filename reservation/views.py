...
# --- बाकी के imports वैसे ही रहेंगे ---
...
# ==============================================================================
# 1. यह एक नया हेल्पर फंक्शन है जो PDF बनाता है
# ==============================================================================
...
# ==============================================================================
# 2. यह `confirm_payment_view` है, जिसमें ईमेल भेजने का कोड जोड़ा गया है
# ==============================================================================
@login_required
def confirm_payment_view(request, booking_id):
    ...
    if request.method == 'POST':
        if request.user.credits >= booking.total_cost:
            ...
            # --- यहाँ ईमेल भेजने का लॉजिक शुरू होता है ---
            try:
                passengers = booking.passengers.all()
                # स्टेप 1: PDF बनाना
                pdf_buffer = generate_ticket_pdf(booking, passengers)

                # स्टेप 2: ईमेल तैयार करना
                ...
                email = EmailMessage(
                    subject,
                    body,
                    'your_gmail_address@gmail.com',  # <-- यहाँ अपना Gmail एड्रेस दोबारा डालें
                    [booking.user.email]
                )
                
                # स्टेप 3: PDF अटैच करना और ईमेल भेजना
...
# ==============================================================================
# 3. बाकी सभी फंक्शन वैसे ही रहेंगे (कोई बदलाव नहीं)
# ==============================================================================
